...
$sql="SELECT * FROM `tab_importer` WHERE `name_of_company` = '$namelist'  ";
...
//while($row = mysql_fetch_array($result)){ 
		print "<font color=\"Black\" size=\"5\"><b>Importer's $namelist Record </b></font>";
...
{
echo "<p align=\"center\"><h3>Importer's didn't exist. Back to search page</h3></p><a href=\"disp-importer.php\">Back to Search Form</a><br>";
}
 //////////////////////////////////
...
$result1 = mysql_query($sql1);
  $number_of_rows1 = mysql_num_rows($result1);            
			...
			print "<table border=1 align=center>";	
//while($row = mysql_fetch_array($result)){ 
		print "<font color=\"Black\" size=\"5\"><b>Importer's $namelist Declarant Information </b></font>";
...
$result2 = mysql_query($sql2);
  $number_of_rows2 = mysql_num_rows($result2);            
            ...
            { 
print "<br>";
print "<font color=\"Black\" size=\"5\"><b>Importer's $namelist Item Record </b></font>";
