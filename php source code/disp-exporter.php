...
<title>View all Exporters</title>
<style type="text/css">
<!--
...
//while($row = mysql_fetch_array($result)){ 
		print "<font color=\"Black\" size=\"5\"><b>Exporter's Record </b></font>";
...
print "</tr>";	
	...
	print "</table>";	
			?>	     
			<br />
	<form action="disp-exporter1.php" method="post">	
