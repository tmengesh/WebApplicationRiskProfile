...
?>
  ...
  <tr>
    ...
    <td width="20%"><label>
    <input name="txtoffence" type="text" id="txtoffence" "/>
    </label></td>
    <td width="1%">&nbsp;</td>
    ...
    <td width="20%" colspan="2"><span class="lineItem"><a 
      ...
      <input name="txtcpc" type="text" id="txtcpc" onfocus="blur();"  value="<?php print "$cpc";?>"  />
    </a></span></td>
    <td width="1%">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2"><a href="javascript:NewCal('txtdob','ddmmmyyyy')"></a><a 
      ...
      <input name="txtdeclarant" type="text" id="txtdeclarant" onfocus="blur();"  value="<?php print "$dnumber";?>"/>
    </a></td>
    <td>&nbsp;</td>
    <td><span class="style13">CIF</span></td>
    <td><input name="txtcif" type="text" id="txtcif" onfocus="blur();"  value="<?php print "$cif";?>"  /></td>
  </tr>
  
  
  <tr>
    <td><span class="style13">Initial Tax </span></td>
    <td><input name="txtitax" type="text" id="txtitax" onfocus="blur();"  value="<?php print "$itax";?>" /></td>
    <td>&nbsp;</td>
    <td bgcolor="#FFFFCC"><span class="style13">TOP Up </span></td>
    <td colspan="2" bgcolor="#FFFFCC"><input name="txttopup" type="text" id="txttopup" onfocus="blur();"  value="<?php print "$topup";?>" /></td>
    <td>&nbsp;</td>
    <td bgcolor="#FFFFCC"><span class="style13">Total Tax </span></td>
    <td bgcolor="#FFFFCC"><input name="txttotal" type="text" id="txttotal" onfocus="blur();"  value="<?php print "$ttax";?>"  /></td>
  </tr>
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFCC"><input name="txtrisk" type="text" id="txtrisk" onfocus="blur();"  value="<?php print "$risklevel";?>" /></td>
    <td rowspan="2">&nbsp;</td>
    <td bgcolor="#FFFFCC"><span class="style13">Goods Description </span></td>
    <td bgcolor="#FFFFCC"><input name="txtgoods" type="text" id="txtgoods" onfocus="blur();"  value="<?php print "$goods";?>"  ></td>
  </tr>
  <tr>
    <td><span class="style13">Company Name </span></td>
    <td><input name="txtname" type="text" id="txtname" onfocus="blur();"  value="<?php print "$cname";?>"/></td>
...
VALUES ('$offence1' , '$cpc' , '$origin' , '$shipment' ,  '$trade' , '$madein' , '$status' , '$dec' , '$cif' , '$itax' , '$topup' , '$totaltax' , '$invest' , '$risk' , '$goods' , '$cname' )" ;
...
echo "<p align=\"center\"><h3>Your Insertion has been done Successfully!</h3></p><a href=\"formmenu.php\">Back to Main Menu</a><br>";
