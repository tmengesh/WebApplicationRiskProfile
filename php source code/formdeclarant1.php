...
?>
  ...
  <tr>
    ...
    <td width="20%"><input name="txtdname" type="text" id="txtdname" onfocus="blur();"  value="<?php print "$dname";?>" /></td>
  </tr>
  <tr>
    <td><span class="style13">Declarant Number </span></td>
    <td><input name="txtdnumber" type="text" id="txtdnumber" onfocus="blur();"  value="<?php print "$dnumber";?>" /></td>
    <td>&nbsp;</td>
    <td><span class="style13">Declarant Address </span></td>
    <td colspan="2"><input name="txtdaddress" type="text" id="txtdaddress" onfocus="blur();"  value="<?php print "$daddress";?>"/></td>
    <td>&nbsp;</td>
    <td><span class="style13">Importer/Exporter Name </span></td>
    <td><input name="txtcon" type="text" id="txtcon" onfocus="blur();"  value="<?php print "$cname";?>" /></td>
  </tr>
  <tr>
    ...
    <td rowspan="3"><input name="txtgoods" type="text" id="txtgoods" onfocus="blur();"  value="<?php print "$goods";?>"/></td>
  </tr>
  <tr>
    <td colspan="2"></td>
  </tr>
  <tr>
    <td colspan="2" class="style30"><input name="txths" type="text" id="txths" onfocus="blur();"  value="<?php print "$hs";?>" /></td>
  </tr>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFCC"><input name="txtcif" type="text" id="txtcif" onfocus="blur();"  value="<?php print "$cif";?>" /></td>
    <td bgcolor="#FFFFCC">&nbsp;</td>
    <td bgcolor="#FFFFCC"><span class="style13">Initial Tax </span></td>
    <td colspan="2" bgcolor="#FFFFCC"><input name="txtitax" type="text" id="txtitax" onfocus="blur();"  value="<?php print "$itax";?>" /></td>
    <td>&nbsp;</td>
    <td bgcolor="#FFFFCC"><span class="style13">Top Up </span></td>
    <td bgcolor="#FFFFCC"><input name="txttopup" type="text" id="txttopup" onfocus="blur();"  value="<?php print "$topup";?>"/></td>
  </tr>
  <tr>
...
echo "<p align=\"center\"><h3>Your Insertion has been done Successfully!</h3></p><a href=\"formitem11.php\">Next<br>";
