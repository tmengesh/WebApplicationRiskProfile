...
<title>Welcome to Fraud made by Exporters Registration form</title>
...
.style52 {font-size: 13px; font-weight: bold; color: #000000; }
.style55 {font-size: 13px; font-weight: bold; color: #990033; }
-->
</style>
...
?>
  ...
  <tr>
    ...
    <td width="1%" rowspan="16">&nbsp;</td>
    <td colspan="9"><div align="center"><span class="style7">Welcome to Exporters Registration form </span><span class="style8"></span></div></td>
    <td width="3%">&nbsp;</td>
  </tr>
  <tr>
...
Misdiscription</span></td>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFCC"><input name="txtgoods" type="text" id="txtgoods" /></td>
    <td colspan="2" bgcolor="#FFFFCC"><span class="style50">
    <input type="radio" name="fraud" onclick="check(this.value)" value="Extra Items" />
Extra Items</span></td>
    </tr>
  <tr>
    <td rowspan="2"><span class="style52">CPC Code </span></td>
    <td rowspan="2"><input name="txtcpc" type="text" id="txtcpc" /></td>
...
Counterfit</span>	</td>
  ...
  <tr>
    <td><span class="style13">Circumstance</span></td>
    <td><input name="txtcir" type="text" id="txtcir" /></td>
    <td bgcolor="#FFFFCC"><span class="style13">Risk Level</span></td>
    <td colspan="2" bgcolor="#FFFFCC"><input name="txtrisklevel" type="text" id="txtrisklevel" /></td>
    <td colspan="2" bgcolor="#FFFFCC"><span class="style50">
    <input type="radio" name="fraud" onclick="check(this.value)" value="Misclassification" />
Misclassification</span></td>
    </tr>
  <tr>
    <td><span class="style55">CIF in Birr </span></td>
    <td><input name="txtcif" type="text" id="txtcif" value="0.00" onfocus="blur()" /></td>
    <td><span class="style55">Initial Tax  in Birr </span></td>
    <td colspan="2"><input name="txtitax" type="text" id="txtitax"  value="0.00" onfocus="blur()"/></td>
    <td colspan="2" bgcolor="#FFFFCC"><span class="style50">
    <input type="radio" name="fraud" onclick="check(this.value)" value="Other" />
Other</span></td>
    </tr>
  <tr>
    <td><span class="style55">TOP UP   in Birr </span></td>
    <td><input name="txttopup" type="text" id="txttopup" value="0.00" onfocus="blur()"/></td>
    <td><span class="style55">Total Tax in Birr </span></td>
    <td colspan="2"><input name="txttotal" type="text" id="txttotal" value="0.00" onfocus="blur()" /></td>
    <td bgcolor="#FFFFCC">&nbsp;</td>
    <td bgcolor="#FFFFCC">&nbsp;</td>
  </tr>
  <tr>
    <td><span class="style13">Examiner Name </span></td>
    <td><input name="txtexaminer" type="text" id="txtexaminer" /></td>
  ...
  <tr>
    ...
    <td><a href="disp-exporter.php" class="style26 style27">View all Exporters </a></td>
  </tr>
  </form>
</table>
...
$message="";
 ...
 {  
$result="INSERT INTO `tab_exporter` ( `office_code` , `name_of_company` , `dec_reg_no` , `association_name` , `declarant_name` , `declarant_number` , `declarant_address` , `status` , `tin_no` , `vat_reg_no` , `address` , `name_of_principal` , `nature_of_business` , `secondary_business` , `consignor` , `fraud` , `mot` , `mot_id` , `risk_indicators` , `examination_date` , `goods_description` , `hs_code` , `cpc_code` , `circumstance` , `risk_level` , `examiner_name`  , `officer_name`) 
VALUES ('$office' , '$cname' , '$dec' , '$aname' ,  '$dname' , '$dnumber' , '$daddress' , '$status' , '$tin' , '$vat' , '$address' , '$principal' , '$nature' , '$secondary' , '$consignor' , '$fraud' , '$mot' , '$motid' , '$risk' , '$edate' , '$goods' , '$hs' , '$cpc' , '$cir' , '$risklevel', '$examiner' , '$officer')" ;
